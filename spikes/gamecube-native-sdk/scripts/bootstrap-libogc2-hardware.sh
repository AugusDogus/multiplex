...
source_dir="$spike_dir/.libogc2-hardware"
stage_dir="$spike_dir/.libogc2-hardware-stage"
patch_file="$spike_dir/patches/libogc2-limit-bba-tcp-receive-window.patch"
