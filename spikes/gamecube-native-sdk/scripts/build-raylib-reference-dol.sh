...
for dependency in \
  "$spike_dir/.libogc2-stage/opt/devkitpro/libogc2/gamecube/lib/libogc.a" \
  "$spike_dir/.opengx-build/libopengx.a" \
  "$spike_dir/.raylib/src/libraylib.a"
do
...
test -s "$spike_dir/multiplex-gamecube-raylib-reference.dol"

dol_size=$(wc -c <"$spike_dir/multiplex-gamecube-raylib-reference.dol")
echo "Experimental raylib reference DOL is ready at $spike_dir/multiplex-gamecube-raylib-reference.dol ($dol_size bytes)"
