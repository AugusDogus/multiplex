...
libogc2_tcp_window_patch="$spike_dir/patches/libogc2-expand-tcp-receive-window.patch"
libogc2_tcp_sequence_patch="$spike_dir/patches/libogc2-lwip-rfc-snd-nxt.patch"
for patch_file in "$libogc2_patch" "$libogc2_bba_wrap_patch" "$libogc2_bba_recovery_patch" "$libogc2_bba_pbuf_patch" "$libogc2_tcp_window_patch" "$libogc2_tcp_sequence_patch"; do
...
libogc2_input="$LIBOGC2_COMMIT $(cksum "$libogc2_patch") $(cksum "$libogc2_bba_wrap_patch") $(cksum "$libogc2_bba_recovery_patch") $(cksum "$libogc2_bba_pbuf_patch") $(cksum "$libogc2_tcp_window_patch") $(cksum "$libogc2_tcp_sequence_patch")"
