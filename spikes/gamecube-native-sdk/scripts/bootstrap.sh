...
libogc2_bba_patch="$spike_dir/patches/libogc2-bba-one-packet-interrupt.patch"
for patch_file in "$libogc2_patch" "$libogc2_bba_patch"; do
...
libogc2_input="$LIBOGC2_COMMIT $(cksum "$libogc2_patch") $(cksum "$libogc2_bba_patch")"
