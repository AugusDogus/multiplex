...
enum {
  MULTIPLEX_INPUT_FOCUS_LEFT = 0,
  MULTIPLEX_INPUT_FOCUS_RIGHT = 1,
  MULTIPLEX_INPUT_CONFIRM = 2,
  MULTIPLEX_INPUT_BACK = 3,
  MULTIPLEX_INPUT_HOME = 4,
  MULTIPLEX_INPUT_SEARCH = 5,
  MULTIPLEX_INPUT_PAGE_FORWARD = 6,
  MULTIPLEX_INPUT_PAGE_BACK = 7,
  MULTIPLEX_INPUT_FOCUS_UP = 8,
  MULTIPLEX_INPUT_FOCUS_DOWN = 9,
  MULTIPLEX_INPUT_PLAYER_SETTINGS = 10,
  MULTIPLEX_INPUT_START = 11,
  MULTIPLEX_INPUT_SEARCH_CURSOR_LEFT = 12,
  MULTIPLEX_INPUT_SEARCH_CURSOR_RIGHT = 13,
};
