...
test -s "$app_dir/multiplex-gamecube-bba-diagnostics.dol"
dol_size=$(wc -c <"$app_dir/multiplex-gamecube-bba-diagnostics.dol")
echo "BBA diagnostic DOL is ready at $app_dir/multiplex-gamecube-bba-diagnostics.dol ($dol_size bytes)"
