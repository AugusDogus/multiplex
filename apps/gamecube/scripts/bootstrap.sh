...
libogc2_dir="$app_dir/.libogc2"
libogc2_url="https://github.com/extremscorner/libogc2.git"
libogc2_stage="$app_dir/.libogc2-stage"
...
libogc2_patch="$app_dir/patches/libogc2-flush-tcp-writes.patch"
libogc2_bba_wrap_patch="$app_dir/patches/libogc2-wrap-bba-receive-dma.patch"
libogc2_bba_recovery_patch="$app_dir/patches/libogc2-recover-malformed-bba-descriptors.patch"
libogc2_bba_pbuf_patch="$app_dir/patches/libogc2-drop-bba-packet-on-pbuf-exhaustion.patch"
libogc2_tcp_sequence_patch="$app_dir/patches/libogc2-lwip-rfc-snd-nxt.patch"
libogc2_tcp_window_patch="$app_dir/patches/libogc2-flush-tcp-window-updates.patch"
libogc2_bba_link_patch="$app_dir/patches/libogc2-start-bba-after-link.patch"
libogc2_dhcp_worker_patch="$app_dir/patches/libogc2-start-network-worker-before-dhcp.patch"
...
libogc2_bba_poll_patch="$app_dir/patches/libogc2-poll-bba-receive.patch"
libogc2_exception_report_patch="$app_dir/patches/libogc2-report-fatal-exceptions.patch"
for patch_file in "$libogc2_patch" "$libogc2_bba_wrap_patch" "$libogc2_bba_recovery_patch" "$libogc2_bba_pbuf_patch" "$libogc2_tcp_sequence_patch" "$libogc2_tcp_window_patch" "$libogc2_bba_link_patch" "$libogc2_dhcp_worker_patch" "$libogc2_dhcp_state_patch" "$libogc2_network_retry_patch" "$libogc2_bba_poll_patch" "$libogc2_exception_report_patch"; do
...
mplayer_dir="$app_dir/.mplayer-ce-libogc2"
