...
export function MobileNav({ session, userInfo }: MobileNavProps) {
  ...
  // A library page is active when the user is on the libraries index or any
  // specific library route.
  const isOnLibraryRoute =
    pathname === "/libraries" ||
    pathname.startsWith("/media") ||
    pathname.startsWith("/live-tv");

  const activeTab: ActiveTab = youOpen
    ? "you"
    : searchOpen
      ? "search"
      : pathname === "/"
