...
export function SidebarAll({ servers, serverLibraries, sidebarSources, onBack }: SidebarAllProps) {
  return (
    <>
      {/* Back Button */}
      <SidebarGroup>
      ...
      {servers.map((server) => {
        ...
        const sources = sidebarSources.librarySourcesByServer[server.clientIdentifier] ?? [];
